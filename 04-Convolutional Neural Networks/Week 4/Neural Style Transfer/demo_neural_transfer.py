...
def compute_style_cost(model, STYLE_LAYERS):
    ...
    for layer_name, coeff in STYLE_LAYERS:
        ...
        # and isn't evaluated yet. Later in the code, we'll assign the image input, s G as the modelo that
...
content_image = imread("images/cat.jpg")  # (600, 800, 3)
content_image = reshape_and_normalize_image(content_image)
style_image = imread("images/drop-of-water.jpg")  # (600, 800, 3)
